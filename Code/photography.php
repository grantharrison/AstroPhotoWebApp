    ...
    <body>
        ...
        <div class="photos">
            ...
            <div class="row">
                ...
                <div class="column">
                    <img onclick="openModal();currentSlide(2)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/AZchukchiSea.jpg" alt="sea" >
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(3)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/australiaBasin.jpg" alt="basin" >
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(4)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/HawaiiKilauea.jpg" alt="hawaii" >
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(5)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/AlaskaYakutat.jpg" alt="yaku">
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(6)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/Africastheewaterskloof.jpg" alt="africa">
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(7)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/campfire.jpg" alt="camp" >
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(8)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/BangladeshPadma.jpg" alt="padma">
                </div>
                <div class="column">
                    <img onclick="openModal();currentSlide(9)" class="arielPhotos hover-shadow cursor" type="image" src="css/images/CAwoolseyFire.jpg" alt="fire">
                </div>
            </div>
        </div> 
